...
\begin{figure}[!h]
  \centering
  \hspace*{-3ex}
		\subfigure{\includegraphics[width=0.47\linewidth]{waveformkeiichi}}
...
\begin{figure}[!h]
  \centering
  \hspace*{-3ex}
  	\subfigure{\includegraphics[width=0.52\linewidth]{angulartemporary.jpg}}	        \caption{Angular dependence of the sudden appearance radio energy. The energy is what would be observed at 1 meter. The shaded area is the simulation and the error band accounts for \color{red} ??? \color{black}}
  \label{fig:angdist}
\end{figure}
